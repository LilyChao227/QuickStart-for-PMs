...
## 1.2. 迭代与迭代中的工作
迭代（sprint），是一个敏捷（scrum）的概念。但是我们不用管它，因为在这里没有真正的敏捷（当然，“真正的敏捷”这个概念似乎也不太符合<a href="https://agilemanifesto.org/iso/zhchs/manifesto.html" target="_blank">敏捷宣言</a>的期待）。  
...
> <a href="https://www.thoughtworks.com/zh-cn/insights/blog/testing/shift-left-testing" target="_blank">“测试左移”</a>也是一种软件开发实践，它要求研发人员在研发的过程中，同步进行测试，以减少代码缺陷和返工造成的资源浪费。
...
4. **需求详述**：最重要的部分，在这个部分，你需要彻底且清晰地描述你想要做什么，以及怎么做。这里唯一的标准就是，你要知道你自己在说什么，并且争取做到让所有人看完之后都知道你在说什么。常见的工具有原型图、列表、流程图、伪代码等。厂内的知识库工具原生支持大部分<a href="https://markdown.com.cn/" target="_blank">Markdown</a>语法，你也应该用起来。
...
### 1.4.5 小流量
<a href="https://zh.wikipedia.org/wiki/%E6%91%A9%E8%8F%B2%E5%AE%9A%E7%90%86" target="_blank">墨菲定律</a>告诉我们，凡是有可能发生的事故，就一定会发生。如果你的产品涉及到较大的用户群体，或者比较重要的公司收入，那么你引起事故的风险就不容小觑。火苗最好是在还小的时候扑灭，以免越烧越旺。  
...
![数据表模型图](sources/table_model.png)
...
1. **表权限**：如上所述，数据仓库可能涵盖了整个公司所有的业务，因此它会提供巨大量级的数据表。有的表和你的工作无关，有的表数据敏感（具有公民隐私信息等），有的表已经过时，有的表已被废弃。所以对于你来说，你只需要拿到必要的表的查询权限即可（<a href="https://www.cloudflare-cn.com/learning/access-management/principle-of-least-privilege/" target="_blank">什么是最低权限原则？</a>）。你需要用到的数据表权限，在这里统一管理：数据管理平台
...
在此之外，你可能需要了解一下窗口函数（<a href="http://www.postgres.cn/docs/9.3/tutorial-window.html" target="_blank">PostgresSQL中文手册：窗口函数</a>）和CTE（<a href="http://www.postgres.cn/docs/9.3/queries-with.html" target="_blank">PostgresSQL中文手册：WITH查询</a>），但是这不必需，所以我也不在这里展开。
### 2.2.2 Excel
...
你可能还感兴趣：
- <a href="https://aws.amazon.com/cn/training/learn-about/cloud-practitioner/" target="_blank">AWS亚马逊云从业者认证培训</a>：了解云基础设施和分布式开发的基本知识
- <a href="https://scrumguides.org/docs/scrumguide/v2020/2020-Scrum-Guide-Chinese-Simplified.pdf" target="_blank">SCRUM指南中文版</a>：了解敏捷的游戏规则
- <a href="https://www.scrum.cn/" target="_blank">SCRUM中文网</a>
- Pandas：厂内大模型工具平台
